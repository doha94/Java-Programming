...
public class Quection1 {
	public static void main(String[] args) {
		System.out.println("무엇을 계산하는 코드인가? 실행 결과 출력되는 내용은?");
		System.out.println("배열 n에 저장된 숫자 중에서 양수이고 4의 배수인 인덱스를 출력하는 코드");
		System.out.println("출력은 3, 5, 7이다.");		
	}
}
